...
htmlhelp_basename = 'moat-gpio-doc'
...
latex_documents = [
    (master_doc, 'moat-gpio.tex', 'Trio Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'moat-gpio', 'MoaT-GPIO Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'moat-gpio', 'MoaT-GPIO Documentation',
     author, 'MoaT-GPIO', 'Control GPIO lines via AMQP',
     'Miscellaneous'),
]
